...
export const CANONICAL_RUNTIME_ADAPTER_VERSION='canonical-runtime-adapter-v1-20260924';
...
export function buildRuntimeCanonicalBundle({
 ...
 public_evidence=null,liquidation_intelligence=null,futures_component=null,execution_handoff=null,data_sufficiency=null,
}={}){
 ...
 const canonical=buildCanonicalAnalyticalResult({
  ...
  liquidations:pump,data_quality:data_sufficiency??null,
