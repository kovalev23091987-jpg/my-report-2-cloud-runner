...
export function buildCanonicalAnalyticalResult({
 ...
 early_candidate=null,opportunity=null,microstructure=null,liquidations=null,data_quality=null,changes_from_previous=[],metadata={},
}={}){
 ...
 const result={
   ...
   early_candidate:early_candidate??null,opportunity:opportunity??null,microstructure:microstructure??null,liquidations:liquidations??null,data_quality:data_quality??null,
...
export function canonicalParity(left,right){
 ...
 const keys=['universe','candidates','state','direction','scores','reasons','source_receipts','hard_gates','entry','trigger','invalidation','targets','early_candidate','opportunity','microstructure','liquidations','data_quality'];
