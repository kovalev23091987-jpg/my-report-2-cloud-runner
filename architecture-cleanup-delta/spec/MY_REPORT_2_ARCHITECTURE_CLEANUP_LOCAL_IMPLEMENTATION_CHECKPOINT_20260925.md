...
## V3 isolated repair
- V1/V2 core architecture work retained unchanged.
- V2 Node24 CI reached read-only replay; diagnostic and unified/free-source replays passed.
- Only failure: `ReferenceError: source_closed_contribution is not defined` inside new 14-day statistics collector.
- V3 fixes the property binding to the existing `source_closed` accumulator and adds regression coverage.
