...
| GoPlus | https://docs.gopluslabs.io/reference/support and Token Security reference | Public docs advertise free use/rate limits around 30 calls/min; current token-security reference shows Authorization header | Do not assume keyless. Adapter/tests prepared; real use BLOCKED/NOT_CONFIGURED until auth behavior proven/approved |
