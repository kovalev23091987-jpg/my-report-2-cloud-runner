...
| 4.4.1 | GoPlus Token Security supporting risk; sale/transfer/mint/owner/concentration etc where available | R070 | BLOCKED | Normalizer exists; current reference shows Authorization; no owner auth supplied. |
| 4.4.2 | GoPlus unsupported/unknown != safe; cache slow facts; no new Hard Gate | R070/R080 | LOCAL_WIRED | Focused tests pass; no live claim. |
...
| 12.9 | GoPlus unknown/unsupported != safe | R070 | LOCAL_PASS_OR_REMOTE_PENDING | Local applicable tests included; Node24/live portions remain explicitly pending. |
