...
import { buildFreeSourceRuntimeSummary } from './source-registry.mjs';

export const CANONICAL_RUNTIME_ADAPTER_VERSION='canonical-runtime-adapter-v2-free-sources-20260925';
...
function reasonFacts({discovery,opportunity,publication}={}){
 ...
 if(routeReason)out.push({label:'Состояние входа',event:routeReason,source:'канонический router'});
...
export function buildRuntimeCanonicalBundle({
 ...
 const freeSources=free_source_summary?.status==='CLOSED'?free_source_summary:buildFreeSourceRuntimeSummary({public_evidence,smart_money_raw,publication_shadow});
