...
def verify_proof():
    ...
    if proof.get('telegram_lifecycle_persistence_only') is not True or proof.get('telegram_lifecycle_dispatch_enabled') is not False: raise RuntimeError('R8_TELEGRAM_SHADOW_PROOF_MISSING')
