...
import { buildFullEvidenceEnvelope, detectEvidenceConflicts, evidenceUsable, normalizeEvidenceItem, summarizeDataQuality, FIXED_DECISION_WEIGHTS } from "../src/full-evidence-contract.mjs";
