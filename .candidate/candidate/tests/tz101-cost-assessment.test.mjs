...
const decision={decision_id:'FD1',snapshot_id:SNAP,contract_code:CONTRACT,direction:'LONG'};
...
const fee=immutableReceipt({schema_version:'tz101-htx-fee-schedule-v1',status:'CLOSED',venue:'HTX',contract_code:CONTRACT,fee_role:'TAKER',entry_rate:0.001,exit_rate:0.001,source_ts:NOW-10_000,valid_until_ts:NOW+60*60_000},'FEE1',NOW-9_000);
const hold=immutableReceipt({schema_version:'tz101-holding-plan-v1',status:'CLOSED',contract_code:CONTRACT,decision_id:'FD1',direction:'LONG',entry_ts:NOW,planned_exit_no_later_than_ts:NOW+60*60_000},'HOLD1',NOW);
...
const crosses=immutableReceipt({schema_version:'tz101-holding-plan-v1',status:'CLOSED',contract_code:CONTRACT,decision_id:'FD1',direction:'LONG',entry_ts:NOW,planned_exit_no_later_than_ts:NOW+3*60*60_000},'HOLD2',NOW);
