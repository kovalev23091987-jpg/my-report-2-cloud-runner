...
assert.match(built.message,/^Рыночная возможность — автоматическая торговля выключена/m);
assert.match(built.message,/AAA\n🟢 ЛОНГ\n✅ МОЖНО ВХОДИТЬ СЕЙЧАС/);
...
console.log("PASS R6 Telegram sidecar exact-decision binding, neutral funding, atomic decision dedupe, delivery uncertainty, and user-position separation");
