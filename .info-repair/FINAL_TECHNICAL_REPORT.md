...
На момент окончательной сборки GitHub `main` повторно прочитан и остаётся на `f12d7c12441c3ddd710b2fd333d90ab402fa6785`. R6 локально проверен; удалённое доказательство R6 будет получено только owner-командой до promotion.
