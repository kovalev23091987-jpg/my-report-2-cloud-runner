...
// R051 measurement support: add required 15m/30m horizons without changing trading thresholds.
const O_OLD=`export const OUTCOME_HORIZONS = Object.freeze({
  "1h": 60 * 60_000,`;
const O_NEW=`export const OUTCOME_HORIZONS = Object.freeze({
  "15m": 15 * 60_000,
  "30m": 30 * 60_000,
  "1h": 60 * 60_000,`;
if(!o.includes(O_OLD))throw new Error('CONSOLIDATED_PATCH_ANCHOR_MISSING:outcome_horizons');
o=o.replace(O_OLD,O_NEW);
...
try{
 ...
 const proof={version:'consolidated-remaining-overlay-v1-20260925',status:'APPLIED',base_candidate_sha:'506be05148a148071a001b39164833473bf515f9',production_base:'08d98579c5ecbeb4de426ffeb1160f25ece52708',
  ...
  hot_cycle_external_request_delta:0,monthly_collapse_threshold_pct:-97,outcome_measurement_horizons_added:['15m','30m'],
