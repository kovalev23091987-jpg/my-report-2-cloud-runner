...
const areaMaterial={schema_version:'tz101-entry-area-rule-v1',status:'CLOSED',calibration_status:'VALIDATED_OUT_OF_SAMPLE',automatic_rule_promotion:false,calibration_receipt_id:'CAL:OOS:1',calibration_dataset_digest:'0123456789abcdef',contract_code:CONTRACT,snapshot_id:SNAP,decision_id:'FD1',direction:'LONG',
