...
export const CANONICAL_RUNTIME_ADAPTER_VERSION='canonical-runtime-adapter-v5-inherited-fact-contract-20260925';
...
function sourceReceipts(publicEvidence){
 ...
 return normalizeInheritedFactEnvelope(rows,{public_evidence:publicEvidence,received_ts:publicEvidence?.observed_ts??Date.now()}).facts;
}
